...
you created in Geogebra.</p>""")
    ...
    def getRichTextFields(self):
        ...
        through all of their fields without having to know the specifics
        of each iDevice type.
        """
        ...
        if not filename.endswith(".jar"):
            if filename.endswith(".html") or filename.endswith(".htm"):
                ...
                if filename.find(",") == -1:
                    ...
                    if self.verifyConn(filename) is False:
                    ...
                    if self.verifyConn(filename[2:]) is False:
                        return html == ''
